...
def training(args):
    ...
    for epoch in range(args.epochs):
        for l_data, u_data in zip(labeled_data_loader, unlabeled_data_loader):
            pt1, pt1A, img1, img1V, centers1, corners1, normals1, neighbor_index1, target1 = l_data #the last one is the target
            pt2, pt2A, img2, img2V, centers2, corners2, normals2, neighbor_index2, target2 = u_data #the last one is the target
...
# 
            ...
            loss = pt_ce_loss + pt_contrast_loss
            ...
            writer.add_scalar('loss/pt_contrast_loss', pt_contrast_loss.item(), iteration)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type=int, default=42, metavar='batch_size',
                        help='Size of batch)')
    ...
    parser.add_argument('--save', type=str,  default='./checkpoints/ModelNet40-pt1024-5percent-entropy-Icontrast/',
