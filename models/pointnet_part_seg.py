...
class PointnetPartSeg(nn.Module):
    ...
    def forward(self, point_cloud):
        ...
        # # cloud_feat = torch.cat([expand, out1, out2, out3, out4, out5], 1)

        # cloud_feat = self.linear1(out_max)

        # # print(cloud_feat.size())
        # #head
        # cloud_out = self.linear2(F.relu(self.bn6(cloud_feat)))
        # # print(cloud_out.size())
        # return cloud_feat, cloud_out
